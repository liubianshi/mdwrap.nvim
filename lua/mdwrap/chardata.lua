...
M.forbit_break_before = {
  ...
  [0xff01] = true, -- ！ Fullwidth exclamation mark（句末，绝不落行首）
  [0xff1a] = true, -- ： Fullwidth colon（句末/句读，绝不落行首）
  [0xff1b] = true, -- ； Fullwidth semicolon（句末，绝不落行首）
  [0xff1f] = true, -- ？ Fullwidth question mark（句末，绝不落行首）
  [0xff0e] = true, -- ． Fullwidth full stop（句末，绝不落行首）
